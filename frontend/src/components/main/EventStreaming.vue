  ...
  events.value = [
    {
      ...
      title: 'Container MAEU1234567 arrived at Port',
      description: 'Container from Shanghai has arrived and is ready for processing',
    ...
    },
    {
      ...
      description: 'Server CPU usage has exceeded 85% threshold',
      eventTime: new Date(Date.now() - 300000).toISOString(), // 5 minutes ago
      severity: 'Critical',
    ...
    },
    {
      ...
      title: 'MSC Oscar has departed',
      description: 'Ship has successfully departed from Berth 3',
      eventTime: new Date(Date.now() - 900000).toISOString(), // 15 minutes ago
      severity: 'Low',
      shipId: 2,
      shipName: 'MSC Oscar',
      berthId: 3,
